// Package kademlia is a GRING implementation of the routing and discovery portion of the Kademlia protocol, with
...
func (p *Protocol) Find(target GRING.PublicKey, opts ...IteratorOption) []GRING.ID {
...
func (p *Protocol) DiscoverTarget(target GRING.PublicKey, opts ...IteratorOption) []GRING.ID {
        return p.Find(p.node.ID().ID, opts...)
}

// Discover attempts to discover new peers to your node through peers your node  already knows about by calling
// the FIND_NODE S/Kademlia RPC call with your nodes ID.
func (p *Protocol) DiscoverRandom(opts ...IteratorOption) []GRING.ID {
...
func (p *Protocol) RemoveConn(id GRING.ID) {
...
func (p *Protocol) ReplaceConn(id GRING.ID) {
...
func (p *Protocol) Ack(id GRING.ID, opcode ...byte) {
...
func (p *Protocol) OnPeerDisconnected(client *GRING.Client) {
