...
func TestTableEviction(t *testing.T) {
	...
	publicKeys := make([]GRING.PublicKey, 0, kademlia.BucketSize+2)
	privateKeys := make([]GRING.PrivateKey, 0, kademlia.BucketSize+2)
	...
	nodes := make([]*GRING.Node, 0, kademlia.BucketSize)
