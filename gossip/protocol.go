// Package gossip is a simple implementation of a gossip protocol for GRING. It keeps track of a cache of messages
...
// Handle implements GRING.Protocol and handles gossip.Message messages.
...
func (p *Protocol) hash(id GRING.ID, data []byte) []byte {
